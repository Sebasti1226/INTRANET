...
function initTiposReporte() {
  ...
  buscarInput.addEventListener("input", (e) => {
    ...
    categoriaCards.forEach(card => {
      ...
      const keywords = card.getAttribute("data-categoria")?.toLowerCase() || "";
      
      if (contenidoCard.includes(textoBusqueda) || keywords.includes(textoBusqueda)) {
  ...
  console.log("✅ Módulo Tipos de Reporte inicializado");
}
